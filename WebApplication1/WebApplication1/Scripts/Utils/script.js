...
$(document).ready(function () {
    $('#Button1').click(function () {
        ...
        $.each(data, function (key, value) {
            ...
            var text = `    <p>
                 <button class="btn btn-light" type="button" data-toggle="collapse" data-target="#collapse_div${key}" aria-expanded="false" aria-controls="collapseExample">
                 ${value.cep}
                    </button>
                    </p>
                   <div class="collapse" id="collapse_div${key}">
                      ...
                      <div class="card-body">
                           <h4>${value.bairro}<\h4>
                           <h4>${value.complemento}<\h4>
                           <h4>${value.gia}<\h4>
                           <h4>${value.ibge}<\h4>
                           <h4>${value.localidade}<\h4>
                           <h4>${value.logradouro}<\h4>   
                           <h4>${value.uf}<\h4>
                           <h4>${value.unidade}<\h4>
                </div>
        </div>
